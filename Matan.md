...
#### Теорема о пределе сходящейся последовательности
...
#### Теорему о локальной ограниченности функции, имеющей конечный предел.
...
#### Докажите, что $\lim\limits_{x→x_0}\frac {sin(x)} x$ = 1.
