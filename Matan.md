...
> Последовательность $\{x_n\}$ называется возрастающей, если $ƒ(n+1)>ƒ(n)$ $∀n$. Если последнее неравенство заменить на $f(n+1)<f(n)$ или $f(n+1)≥f(n)$ или $ƒ(n+1)≤ƒ(n)$, то получим определение соответственно убывающей, неубывающей и невозрастающей последовательностей.
...
> Функция $f : X → ℝ$ называется возрастающей, если $∀x_1,x_2∈X: x_1>x_2$ всегда верно $ƒ(x_1)>ƒ(x_2)$. Если последнее неравенство заменить на $f(x_1)<f(x_2)$ или $f(x_1)≥f(x_2)$ или $ƒ(x_1)≤ƒ(x_2)$, то получим определение соответственно убывающей, неубывающей и невозрастающей функций.
