...
11. Сформулируйте и докажите теорему о произведении бесконечно малой функции на ограниченную [`@`](none)
12. Сформулируйте и докажите теорему о связи между бесконечно большой и бесконечно малой [`@`](none)
13. Сформулируйте и докажите теорему о замене бесконечно малой на эквивалентную под знаком предела [`@`](none)
14. Сформулируйте и докажите теорему о необходимом и достаточном условии эквивалентности бесконечно малых [`@`](none)
15. Сформулируйте и докажите теорему о сумме конечного числа бесконечно малых разных порядков [`@`](none)
16. Сформулируйте и докажите теорему о непрерывности суммы, произведения и частного непрерывных функций [`@`](none)
17. Сформулируйте и докажите теорему о непрерывности сложной функции [`@`](none)
18. Сформулируйте и докажите теорему о сохранении знака непрерывной функции в окрестности точки [`@`](none)
19. Дайте определение функции, непрерывной в точке. Сформулируйте теорему о непрерывности элементарных функций. Докажите непрерывность функций y = sin x, y = cos x [`@`](none)
20. Сформулируйте свойства функций, непрерывных на отрезке [`@`](none)
21. Сформулируйте определение точки разрыва функции и дайте классификацию точек разрыва. На каждый случай приведите примеры [`@`](none)
22. Сформулируйте и докажите необходимое и достаточное условие существования наклонной асимптоты [`@`](none)
23. Сформулируйте и докажите необходимое и достаточное условие дифференцируемости функции в точке [`@`](none)
24. Сформулируйте и докажите теорему о связи дифференцируемости и непрерывности функции [`@`](none)
25. Сформулируйте и докажите теорему о производной произведения двух дифференцируемых функций [`@`](none)
26. Сформулируйте и докажите теорему о производной частного двух дифференцируемых функций [`@`](none)
27. Сформулируйте и докажите теорему о производной сложной функции [`@`](none)
28. Сформулируйте и докажите теорему о производной обратной функции [`@`](none)
29. Сформулируйте и докажите свойство инвариантности формы записи дифференциала первого порядка [`@`](none)
30. Сформулируйте и докажите теорему Ферма [`@`](none)
31. Сформулируйте и докажите теорему Ролля [`@`](none)
32. Сформулируйте и докажите теорему Лагранжа [`@`](none)
33. Сформулируйте и докажите теорему Коши [`@`](none)
34. Сформулируйте и докажите теорему Лопиталя – Бернулли для предела отношения двух бесконечно малых функций [`@`](none)
35. Сравните рост показательной, степенной и логарифмической функций на бесконечности [`@`](none)
36. Выведите формулу Тейлора с остаточным членом в форме Лагранжа [`@`](none)
37. Выведите формулу Тейлора с остаточным членом в форме Пеано [`@`](none)
38. Выведите формулу Маклорена для функции y = e x с остаточным членом в форме Лагранжа [`@`](none)
39. Выведите формулу Маклорена для функции y = sin x с остаточным членом в форме Лагранжа [`@`](none)
40. Выведите формулу Маклорена для функции y = cos x с остаточным членом в форме Лагранжа [`@`](none)
41. Выведите формулу Маклорена для функции y = ln(1 + x) с остаточным членом в форме Лагранжа [`@`](none)
42. Выведите формулу Маклорена для функции y = (1 + x) α с остаточным членом в форме Лагранжа [`@`](none)
43. Сформулируйте и докажите необходимое и достаточное условие неубывания дифференцируемой функции [`@`](none)
44. Сформулируйте и докажите необходимое и достаточное условие невозрастания дифференцируемой функции [`@`](none)
45. Сформулируйте и докажите первое достаточное условие экстремума (по первой производной) [`@`](none)
46. Сформулируйте и докажите второе достаточное условие экстремума (по второй производной) [`@`](none)
47. Сформулируйте и докажите достаточное условие выпуклости функции [`@`](none)
48. Сформулируйте и докажите необходимое условие точки перегиба [`@`](none)
49. Сформулируйте и докажите достаточное условие точки перегиба [`@`](none)
...
> Элементы $+∞$ и $−∞$ называются *бесконечными числами*, а действительные числа – *конечными числами*
...
> Пусть функция ƒ(x) определена в [проколотой окрестности](#проколотая-окрестность-точки) $\mathring{U}(x_0)$ точки $x_0$. Элемент $𝑎∈\={ℝ}$ называется пределом функции $ƒ(x)$ при $x→x_0$, если ∀ε>0 ∃δ=δ(ε)>0: $0<|x−x_0|<δ$ ⇒ $|ƒ(x)−a|<ε$. Обозначение: $\lim\limits_{x→x_0}f(x)=a,$ или $ƒ(x)→a$ при $x→x_0$.
...
> Пусть ε>0. ε-окрестность точки $x_0$ $U_ε(x_0):=(x_0-ε, x_0+ε).$

#### Проколотая ε-окрестность точки

> Если $U_ε(x_0)$ — окрестность точки $x_0,$ то проколотая ε-окрестность точки $x_0$ $\mathring{U}_ε(x_0):=U_ε(x_0)$ \ $\{x_0\}$
...
>
> - возрастающей, если $∀n$ $x_{n+1}>x_n;$
> - убывающей, если $∀n$ $x_{n+1}<x_n;$
...
Определение: [предел числовой последовательности](#предел-числовой-последовательности).
...
#### Выведите формулу Маклорена для функции y = (1 + x) α с остаточным членом в форме Лагранжа.
